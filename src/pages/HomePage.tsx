  ...
  <div id="services" data-section="services">
    <SectionErrorBoundary name="services">
      ...
      items={[
        {
          title: "תספורות גברים",
          description: "תספורות קלאסיות, פיידים ועיצובים מודרניים.",
          buttonIcon: "Scissors",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-barber-combing-moustache-client_23-2147778838.jpg",
        },
        {
          title: "תספורות נשים",
          description: "עיצוב, דירוג, ויעוץ מקצועי לתוצאה מושלמת.",
          buttonIcon: "Sparkles",
        ...
        {
          title: "תספורות ילדים",
          description: "חוויה נעימה ומקצועית גם לקטנטנים.",
          buttonIcon: "Smile",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-girl-getting-haircut-salon_23-2149870393.jpg",
        },
        {
          title: "עיצוב זקן",
          description: "סידור ועיצוב זקן ברמה גבוהה.",
          buttonIcon: "Scissors",
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-man-getting-haircut_23-2150665414.jpg",
        },
        {
          title: "טיפולי שיער",
          description: "טיפולים משקמים לשיער בריא וזוהר.",
          buttonIcon: "Heart",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-drying-hair-young-girl_23-2147769807.jpg",
        },
        {
          title: "עיצוב שיער לאירועים",
          description: "עיצוב שיער מותאם אישית לאירועים מיוחדים.",
          buttonIcon: "Crown",
  ...
  <div id="gallery" data-section="gallery">
    <SectionErrorBoundary name="gallery">
      ...
      items={[
        ...
        {
          title: "תוצאה סופית",
          description: "לקוח מרוצה לאחר טיפול.",
          href: "#",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-smiley-woman-getting-haircut_23-2148817196.jpg",
        },
        {
          title: "סגנון מודרני",
          description: "תספורת טרנדית ומעודכנת.",
          href: "#",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-handsome-fashion-stylish-hipster-model-dressed-warm-sweater-posing-studio_158538-11451.jpg",
        },
      ]}
    />
    </SectionErrorBoundary>
      ...
      testimonials={[
        {
          name: "יוסי כהן",
          role: "לקוח קבוע",
          quote: "המספרה הכי טובה בגבעתיים, שירות מקצועי ויחס אישי.",
        ...
        },
        {
          name: "דנה לוי",
          role: "לקוחה",
          quote: "ממליצה בחום! עיצוב שיער ברמה גבוהה מאוד.",
        ...
        },
        {
          name: "אבי רוזן",
          role: "לקוח",
          quote: "מקצוענות ללא פשרות, תספורת מדויקת בכל פעם.",
        ...
        },
        {
          name: "מיכל סגל",
          role: "לקוחה",
          quote: "אווירה נעימה ושירות מדהים, בהחלט אחזור שוב.",
        ...
        },
        {
          name: "רועי דויד",
          role: "לקוח",
          quote: "ספר תותח, ממליץ לכל מי שמחפש סטייל ברמה גבוהה.",
    ...
    <SectionErrorBoundary name="team">
      ...
      members={[
        ...
        },
        {
          name: "משה",
          role: "ברבר בכיר",
          imageSrc: "http://img.b2bpic.net/free-photo/expressive-young-woman-posing_176474-26075.jpg",
        },
        {
          name: "שרה",
          role: "סטייליסטית",
      ...
      categories={[
        {
          ...
          items: [
            {
              question: "האם צריך לקבוע תור?",
              answer: "מומלץ לקבוע תור מראש כדי להבטיח זמינות.",
            },
            {
              question: "האם יש שירות כניסה חופשית (Walk-in)?",
              answer: "משתדלים לתת שירות גם ללא תור במידה ויש זמינות.",
            },
            {
              question: "כמה זמן נמשכת תספורת?",
              answer: "בין 30 ל-60 דקות בהתאם לסוג השירות.",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              answer: "כן, יש חניה כחול-לבן ובתשלום קרוב.",
            },
            {
            ...
            },
            {
              ...
              answer: "א'-ה': 09:00-20:00, ו': 08:00-14:00.",
            },
          ],
        },
      ]}
